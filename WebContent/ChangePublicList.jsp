...
<%
ArrayList<Model_Directory> ps = (ArrayList<Model_Directory>) session.getAttribute("publist");
%>
<table>
...
<td><a href="ChangeAccessController?flag=pubchange&dirid=<%=ps.get(i).getDir_Id()%>&dirname=<%=ps.get(i).getDirName()%>&dirtype=<%=ps.get(i).getDirType()%>">Change Permission</a>||
